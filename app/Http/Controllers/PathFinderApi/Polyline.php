...
class Polyline
{
    ...
    final public static function getPointsFromPolylineObject ($polyline)
    {
        $points = array();
        foreach ($polyline as $coordinate)
        {
            array_push($points,[$coordinate->latitude,$coordinate->longitude]);
        }
        return $points;
    }

    final public static function getPointsFromPolylineArray ($polyline)
    {
        $points = array();
        foreach ($polyline as $coordinate)
        {
